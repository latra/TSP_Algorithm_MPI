...
#include <cstdio>
const unsigned int MAXPILA =10000;
...
#endif
static const int JOB_REQUEST = 0;
static const int JOB_SENDED = 1;
static const int NODE_PUSH = 2;
static const int NODE_SOLUTION = 3;
static const int JOB_ENDED = 4;

static const int STATUS_SLEEP = 0;
static const int STATUS_WORKING = 1;
/* ********************************************************************* */
...
bool StillRunning(tPila *pila, int slaveStatus[], int slaves);
...
void InfiereArcos(tNodo *nodo, int** tsp);
  /* Infiere nuevos arcos a incluir enmpi_car_type
...
void EscribeSolucion (tNodo *nodo, double t, int rango); 
...
/* ******************************************************************** */
// Funciones para tratar los mensajes en MPI
void UnpackNodo();
